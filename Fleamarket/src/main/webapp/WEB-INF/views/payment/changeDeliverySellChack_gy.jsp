...
<% 
/* String item_no1 = request.getParameter("purchaseNo");
...
System.out.println(item_no + " : 아이템 no 22");
System.out.println("셀체크제대로 왔습니다.");
...
response.sendRedirect("sell_list_gy.jsp"); */
%>
<html>
<head>
